    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
      {loading && (
        <div className="fixed inset-0 z-50 flex flex-col items-center justify-center bg-white/80 backdrop-blur-sm">
          ...
          <p className="text-base font-medium text-gray-600">Creating your account…</p>
        </div>
      )}

      <div className="w-full max-w-md bg-white rounded-2xl shadow p-8">
        <h1 className="text-2xl font-bold text-gray-900 mb-2">Create account</h1>
        <p className="text-base text-gray-500 mb-6">Choose how you want to use Clean</p>
        ...
        <div className="grid grid-cols-2 gap-3 mb-6">
          ...
          >
            ...
            <div className="font-semibold text-base text-gray-900">Customer</div>
          ...
          >
            <div className="text-2xl mb-1">🧹</div>
            <div className="font-semibold text-base text-gray-900">Cleaner</div>
